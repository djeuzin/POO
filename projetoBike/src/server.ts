...
import { App } from './app'
import { PrismaUserRepo } from './external/prisma-user-repo'
import { PrismaBikeRepo } from './external/prisma-bike-repo'
import { PrismaRentRepo } from './external/prisma-rents-repo'
...
server.post('/api/users', async (req, res) => {
    try {
        const id = await app.addUser(req.body)
